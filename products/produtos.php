        ...
        <div id="content-page" class="content-page">
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="bg-secondary text-center rounded p-4">
                    ...
                    <h4 class="card-title">Tabela produtos</h4>
                        <a href="">Show All</a>
                    </div>
                    ...
                    <span class="table-add float-right mb-3 mr-2">
							...
							/* PDO
								$stmt = $pdo->prepare("SELECT * FROM produtos ORDER BY id ASCE");
								$stmt->execute();
                        ...
                        <tr class="table-info">
						  ...
						  <td>
							...
							<a class="btn btn-sm btn-danger " href="produtos/deleteQuery.php?id=<?php echo $value['id']; ?>">Apagar</a>
						  </td>
                        </tr>
						<?php  }?>
                        </tbody>
